...
STATIX_UPDATE_PACKAGE := $(PRODUCT_OUT)/$(STATIX_VERSION)-img.zip

.PHONY: updatepackage statix-fastboot
updatepackage: $(INTERNAL_UPDATE_PACKAGE_TARGET)
statix-fastboot: updatepackage
	$(hide) ln -f $(INTERNAL_UPDATE_PACKAGE_TARGET) $(STATIX_UPDATE_PACKAGE)
#	$(hide) $(MD5SUM) $(STATIX_UPDATE_PACKAGE) | sed "s|$(PRODUCT_OUT)/||" > $(STATIX_UPDATE_PACKAGE).md5sum
	@echo " "
	@echo " "
	@echo "                                                              :             "
	@echo "          .                                                  t#,           ."
	...
	@echo " "
	@echo " "
	@echo "Package Complete: $(STATIX_UPDATE_PACKAGE)" >&2
	@echo "Package size: `du -h $(STATIX_UPDATE_PACKAGE) | cut -f 1`"
